...
SHOP_ITEMS = [
    ...
    ['莽夫药剂', 'boor_potion', '10分钟内，提升20%攻击力。战斗爽！！！', 1000, 3, {'time': 600, 'attack_multiple': 0.2}],
    ['懦夫药剂', 'coward_potion', '10分钟内，提升15%防御力和最大生命值。因为太怕痛所以全点防御力和血量了。', 1500, 3, {'time': 600, 'defense_multiple': 0.15, 'max_hp_multiple': 0.15}],
    ['改名卡', 'name_change_card', '对你的游戏ID不满意？那你一定要试试它', 20000, 5, {}],
    ['双倍经验卡', 'double_exp_card', '让你获得的经验翻倍！有效期20分钟。', 5000, 3, {'time': 1200}],
    ['双倍金币卡', 'double_gold_card', '让你获得的金币翻倍！有效期20分钟。', 5000, 3, {'time': 1200}],
]
