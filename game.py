            ...
            if not os.path.exists(self.shop_file):
                with open(self.shop_file, 'w', newline='', encoding='utf-8') as f:
                    ...
                    default_items = [
                        ...
                        ['药水', '出门必备的小药水', 'consumable', '100', '0', '0', '50', '2'],
                        ['急救包', '出事儿了就得靠它', 'consumable', '300', '0', '0', '150', '3'],
                        ['治疗卷轴', '麻瓜总是很难理解卷轴上的符文到底是怎么发挥作用的', 'consumable', '400', '0', '0', '200', '4'],
                        ['原素瓶', '不死人的果粒橙', 'consumable', '1000', '0', '0', '500', '5'],
                        ['杰克的酒', '卡塔利纳的杰克·巴尔多赠予的酒，非常好喝！', 'consumable', '2000', '0', '0', '1000', '5']
                        ['女神的祝福', '来自太阳长女葛温德林的祝福', 'consumable', '99999', '0', '0', '2000', '5']
                    ]
